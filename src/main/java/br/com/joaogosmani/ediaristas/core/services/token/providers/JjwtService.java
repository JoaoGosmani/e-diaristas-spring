package br.com.joaogosmani.ediaristas.core.services.token.providers;
...
public class JjwtService implements TokenService {
    ...
    @Value("${br.com.joaogosmani.ediaristas.access.key}")
    private String accessKey;

    @Value("${br.com.joaogosmani.ediaristas.access.expiration}")
    private int accessExpiration;

    @Value("${br.com.joaogosmani.ediaristas.refresh.key}")
    private String refreshKey;

    @Value("${br.com.joaogosmani.ediaristas.refresh.expiration}")
