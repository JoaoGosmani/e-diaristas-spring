...
import br.com.joaogosmani.ediaristas.web.dtos.ResetarSenhaConfirmacaoForm;
import br.com.joaogosmani.ediaristas.web.dtos.ResetarSenhaForm;
import br.com.joaogosmani.ediaristas.web.services.WebResetarSenhaService;
...
public class ResetarSenhaController {
    ...
    public String resetarSenha(@ModelAttribute ResetarSenhaForm form, RedirectAttributes attrs) {
        service.solicitarResetDeSenha(form);
    ...
    public String confirmacaoResetSenha(
        ...
        try {
            ...
            result.addError(exception.getFieldError());
