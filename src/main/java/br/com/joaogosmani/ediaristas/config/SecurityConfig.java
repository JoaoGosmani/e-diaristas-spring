package br.com.joaogosmani.ediaristas.config;
...
import br.com.joaogosmani.ediaristas.core.filters.AccessTokenRequestFilter;
...
public class SecurityConfig {
    ...
    public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
        ...
        @Value("${br.com.joaogosmani.ediaristas.rememberMe.key}")
        private String rememberMeKey;
    
        @Value("${br.com.joaogosmani.ediaristas.rememberMe.validitySeconds}")
